												...
												<div class="card">
													<div class="card-block">
														...
														<form class="form-material"
															action="<%=request.getContextPath()%>/ServletTelefone" method="post" id="formTelefone">
											...
											<table class="table" id="tabelaResultadosView">
												...
												<tbody>
													<c:forEach items="${modelTelefones}" var="mf">
														<tr>
														 <td><c:out value="${mf.id}"></c:out> </td>
														 <td><c:out value="${mf.Numero}"></c:out> </td>
														 <td><a class="btn btn-success" href="<%= request.getContextPath() %>/ServletTelefone?acao=excluir&id=${mf.id}&userpai=${modelLogin.id}">Excluir</a> </td>
														</tr> 
													</c:forEach>
												</tbody>
											</table>
