			...
			<div class="main-menu-content">
				<ul>
					<li class="more-details">
							...
							<a href="<%=request.getContextPath()%>/ServletLogin?acao=Logout"><i class="ti-layout-sidebar-left"></i>Sair</a></li>
				</ul>
			</div>
		</div>
		...
		<ul class="pcoded-item pcoded-left-item">
			...
			<li class="pcoded-hasmenu"><a href="javascript:void(0)"
				...
				<c:if test="${perfil == 'ADMIN'}">
					<li class=" "><a href="<%=request.getContextPath()%>/ServletUsuarioController?acao=listarUser" class="waves-effect waves-dark"> <!---//FIXA O BUG DE DIRETORIOS -->
